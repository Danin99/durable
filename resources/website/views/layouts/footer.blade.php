<footer class="bg-white shadow-zinc-500 shadow-lg mt-4">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="grid grid-cols-5">
            <div class="mb-6 md:mb-0 col-span-2">
                ...
                <span>
                     One of the biggest IT/Electronic importers in Cambodia. We have partnerships with many big name brands like Dell, Lenovo, and many more.
                </span>
            </div>
            <div>
